                ...
                <div class="editor-form">
                  <div class="form-row identity-row">
                    <div class="field-stack identity-fields">
                      ...
                      <label class="field-block">
                        ...
                        >
                          <option v-for="(value, index) in variantOptions('image')" :key="`image-${index}`" :value="index">
                  ...
                  <div class="form-row two-column-row">
                    <label class="field-block">
                      ...
                      >
                        <option v-for="(value, index) in variantOptions('firstNight')" :key="`first-night-${index}`" :value="index">
                    ...
                    <label class="field-block">
                      ...
                      >
                        <option v-for="(value, index) in variantOptions('otherNight')" :key="`other-night-${index}`" :value="index">
